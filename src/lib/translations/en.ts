const en: Record<string, string> = {
  ...
  "rag.recSmall": "Small knowledge base ({count} chunks). BM25 + basic vector search is enough — reranker not needed yet.",
  "rag.recMedium": "Medium knowledge base ({count} chunks). Vector search + BM25 recommended. Reranker is optional.",
