const ru: Record<string, string> = {
  ...
  "rag.recSmall": "Небольшая база знаний ({count} чанков). BM25 + базовый векторный поиск достаточно — реранкер пока не нужен.",
  "rag.recMedium": "Средняя база знаний ({count} чанков). Рекомендуется векторный поиск + BM25. Реранкер опционален.",
