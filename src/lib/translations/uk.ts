const uk: Record<string, string> = {
  ...
  "rag.recSmall": "Невелика база знань ({count} чанків). BM25 + базовий векторний пошук достатньо — реранкер поки не потрібен.",
  "rag.recMedium": "Середня база знань ({count} чанків). Рекомендується векторний пошук + BM25. Реранкер опціональний.",
